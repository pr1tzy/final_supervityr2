...
const navItems: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/max', label: 'Max AI', icon: Icons.sparkles },
      { href: '/crm', label: 'CRM', icon: Icons.crm },
      { href: '/logs', label: 'Logs', icon: Icons.logs },
      { href: '/workbench', label: 'Workbench', icon: Icons.workbench },
      { href: '/legal', label: 'Legal Hub', icon: Icons.fileText },
      { href: '/payments', label: 'Payments', icon: Icons.barChart },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/ai/insights', label: 'AI Manager', icon: Icons.lightbulb },
    ],
  },
  {
    title: 'System',
